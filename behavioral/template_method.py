...
class AbstractProcessor(ABC):
    ...
    def template_method(self, credit_card_mock: str):
    ...
    def validate_number(self, credit_card_mock: str):
        return f"Validating number for {credit_card_mock}"

    def check_issue_date(self, credit_card_mock: str):
        return f"Checking issue date for {credit_card_mock}"

    def verify_owner(self, credit_card_mock: str):
        return f"Checking owner name for {credit_card_mock}"

    def check_cvc_code(self, credit_card_mock: str):
        return f"Validating CVC number for {credit_card_mock}"

    def check_application_origin(self, credit_card_mock: str):
        pass

    @abstractmethod
    def make_payment(self, credit_card_mock: str):
        pass
